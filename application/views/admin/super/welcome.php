...
<div class="welcome full-page-wrapper">
  ...
  <div class="jumbotron" id="welcome-jumbotron">
    ...
    <!-- <p class="d-xs-none"> // Defined in AdminController
    </p> -->
  </div>
  <?php endif; ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="welcome-modal-title"><?php echo sprintf(gT("Welcome to %s!"), 'LimeSurvey'); ?>
          </h5>
  ...
  <div class="container text-end recent-activity">
    ...
    <span id="last_survey" class="">
      <!-- to enable rotation again set class back to "rotateShown" -->
    ...
    <span id="last_question" class="">
      <!-- to enable rotation again set class back to "rotateHidden" -->
