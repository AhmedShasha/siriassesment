  ...
  <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $this->createUrl('surveyAdministration/listsurveys/active/Y'); ?>">
            <?php eT("Active surveys"); ?> <span class="badge">
              <?php echo $activesurveyscount ?>
            </span>
          </a>
        </li>
        <?php endif; ?>
    ...
    <div class="collapse navbar-collapse justify-content-center">
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item d-flex"><a href="<?php echo $this->createUrl("surveyAdministration/listsurveys"); ?>"
            class="nav-link ps-0">
            <?php eT("Surveys"); ?>
          </a>
          <?php if ($activesurveyscount > 0): ?>
          <a class="nav-link ps-0 active-surveys"
            href="<?php echo $this->createUrl('surveyAdministration/listsurveys/active/Y'); ?>"><span class="badge">
              <?php echo $activesurveyscount ?>
            </span></a>
          <?php endif; ?>
        </li>
    ...
    <div class="collapse navbar-collapse justify-content-end">
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown" role="button"
            aria-expanded="false">
