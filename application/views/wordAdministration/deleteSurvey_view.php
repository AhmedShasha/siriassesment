    ...
    <div class="col-12 content-right">
      ...
      <div class="jumbotron message-box">
        ...
        <p>
          ...
          <span
            class="text-danger"><?php eT("This survey is active and a responses table exists. If you delete this survey, these responses (and files) will be deleted. We recommend that you export the responses before deleting this survey."); ?></span><br /><br />
          <?php endif; ?>


          <?php if ($survey->hasTokensTable): ?>
          <span
            class="text-danger"><?php eT("This survey has an associated participant table. If you delete this survey this participant table will be deleted. We recommend that you export or backup these participants before deleting this survey."); ?><br /><br />
            <?php endif; ?>
        ...
        <p>
          ...
          <input type='button' class="btn btn-lg btn-cancel" value='<?php eT("Cancel"); ?>'
            onclick="window.open('<?php echo Yii::app()->createUrl("surveyAdministration/view/surveyid/$surveyid"); ?>', '_top')" />
