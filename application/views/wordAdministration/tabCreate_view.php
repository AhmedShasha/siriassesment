 ...
 * @var WordAdministrationController $this
 * @var Survey $oSurvey
 *
 */
?>
...
<button role="button" class="btn btn-primary btn-primary d-none" type="submit" name="save"
  id="create_survey_save_and_send" value='insertsurvey'>
  <?php eT("Finish & save"); ?>
</button>
    ...
    <div>
      <div class="tab-pane active" id="texts" data-count="1">
        ...
        <div class="col-4">
          ...
          <!-- Submit -->
          <div class="pt-3">
            <input id="create-survey-submit" type='submit' class="btn btn-primary col-6"
              value='<?php eT("Create survey"); ?>' />
          </div>
        </div>
...
var updateCKfields = function() {
  ...
  if (curCKEDITOR !== null) {
    $('textarea').each(function() {
      var $textarea = $(this);
      if (curCKEDITOR.instances[$textarea.attr('name')] != undefined || curCKEDITOR.instances[$textarea.attr(
          'name')] != null) {
